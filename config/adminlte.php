...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Perfil',
            'url' => 'profile', // Reemplaza 'profile' con la ruta correcta para el perfil del usuario
            'icon' => 'fas fa-user',
        ],
        [
            'text' => 'Cambiar Contraseña',
            'url' => 'change-password', // Reemplaza 'change-password' con la ruta correcta para cambiar la contraseña
            'icon' => 'fas fa-lock',
        ],
        [
            'text' => 'blog',
