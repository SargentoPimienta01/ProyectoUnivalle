                                ...
                                <tbody>
                                    @foreach ($categoriaTramites as $categoriaTramite)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('categoria-tramites.destroy',$categoriaTramite->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('categoria-tramites.show',$categoriaTramite->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Show') }}</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('categoria-tramites.edit',$categoriaTramite->id) }}"><i class="fa fa-fw fa-edit"></i> {{ __('Edit') }}</a>
                                                    @csrf
                                                    @method('DELETE')
