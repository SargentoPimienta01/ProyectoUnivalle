<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('nombre_naf', $naf->nombre_naf, ['class' => 'form-control' . ($errors->has('nombre_naf') ? ' is-invalid' : ''), 'placeholder' => 'Nombre Naf', 'required' => 'required',]) }}
            {!! $errors->first('nombre_naf', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('descripcion') }}
            {{ Form::text('descripcion', $naf->descripcion, ['class' => 'form-control' . ($errors->has('descripcion') ? ' is-invalid' : ''), 'placeholder' => 'Descripción Naf', 'required' => 'required',]) }}
