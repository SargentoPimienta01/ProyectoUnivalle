                    ...
                    @endif
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img class="thumbnail" src="{{ $biblioteca->foto }}"
                                                    onclick="showImagePopup('{{ $biblioteca->foto }}')">
                                            </td>
                                            ...
                                            <!--modal mostrar-->
                                            <div class="modal fade" id="showModal{{$biblioteca->id}}" tabindex="-1"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title " id="modal-title">Detalle anuncio
                                                            </h5>
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            <p><strong>Descripcion:</strong> {{ $biblioteca->descripcion
                                                                }}</p>
                                            ...
                                            <!--<div class="modal fade" id="editModal{{$biblioteca->id}}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{url('bibliotecas/'.$biblioteca->id)}}"
                                                            method="post">
                                                            @method("PUT")
                                                            @csrf
                                                            ...
                                                            <div class="container">
                                                                <div class="my-2">
                                                                    <label for="hora"
                                                                        class="col-sm-2 col-form-label">Hora:</label>
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control"
                                                                            name="hora" id="hora"
                                                                            value="{{$biblioteca->hora}}" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="container">
                                                                <div class="my-5">
                                                                    <div
                                                                        ...
                                                                        <a href="{{url('bibliotecas')}}"
                                                                            class="float-right btn btn-secondary ">Regresar</a>
                                                                        <button type="submit"
                                                                            class="float-left btn btn-warning ">Modificar
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="changeEstadoModal{{ $biblioteca->id }}" tabindex="-1"
                                role="dialog" aria-labelledby="changeEstadoModalLabel{{ $biblioteca->id }}"
                                aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form
                                                action="{{ $biblioteca->estado ? route('bibliotecas.desactivar', $biblioteca->id) : route('bibliotecas.activar', $biblioteca->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PATCH')
                                                <button type="submit"
                                                    class="btn btn-{{ $biblioteca->estado == 1 ? 'danger' : 'success' }}">
                                                    Confirmar Cambio de Estado
                                                </button>
                                            </form>
                                        </div>
